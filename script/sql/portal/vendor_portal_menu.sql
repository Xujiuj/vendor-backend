...
values
(910100, '厂商运营', 0, 1, 'vendor', 'Layout', '', 1, 0, 'M', '0', '0', '', 'guide', 103, 1, sysdate(), null, null, '厂商端运营菜单'),
...
(910101, '客户档案', 910100, 1, 'customer', 'vendor/customer/index', '', 1, 0, 'C', '0', '0', 'vendor:customer:list', 'peoples', 103, 1, sysdate(), null, null, '厂商客户档案，连接真实后端接口'),
(910102, '授权管理', 910100, 2, 'license', 'vendor/licenseIssue/index', '', 1, 0, 'C', '0', '0', 'vendor:licenseIssue:list', 'lock', 103, 1, sysdate(), null, null, '厂商授权签发、撤销与重签入口'),
...
(910121, '因子开放范围', 910136, 2, 'factor-scope', 'vendor/factorScope/index', '', 1, 0, 'C', '0', '0', 'vendor:factorCustomerScope:list', 'tree', 103, 1, sysdate(), null, null, '厂商按版本、客户与套餐控制因子开放范围'),
(910105, '模板库', 910136, 3, 'report-template', 'vendor/reportTemplate/index', '', 1, 0, 'C', '0', '0', 'vendor:reportTemplate:list', 'form', 103, 1, sysdate(), null, null, '厂商报表模板库与发布管理'),
(910106, '模板分发', 910136, 4, 'template-scope', 'vendor/templateScope/index', '', 1, 0, 'C', '0', '0', 'vendor:reportTemplateScope:list', 'share', 103, 1, sysdate(), null, null, '厂商模板按客户与授权分发范围'),
(910131, '维表管理', 910136, 5, 'dimension', 'vendor/dimension/index', '', 1, 0, 'C', '0', '0', 'vendor:dimension:list', 'tree', 103, 1, sysdate(), null, null, '厂商维表管理，供企业端通过开放接口读取基础数据'),
(910126, '公告管理', 910136, 6, 'announcement', 'vendor/announcement/index', '', 1, 0, 'C', '0', '0', 'vendor:announcement:list', 'message', 103, 1, sysdate(), null, null, '厂商公告管理，供企业端工作台按授权同步读取'),
...
(910152, '因子版本发布', 910103, 5, '', '', '', 1, 0, 'F', '0', '0', 'vendor:factorVersion:publish', '#', 103, 1, sysdate(), null, null, '因子版本发布权限'),
(910153, '因子版本冻结', 910103, 6, '', '', '', 1, 0, 'F', '0', '0', 'vendor:factorVersion:freeze', '#', 103, 1, sysdate(), null, null, '因子版本冻结权限'),
(910154, '因子版本退役', 910103, 7, '', '', '', 1, 0, 'F', '0', '0', 'vendor:factorVersion:retire', '#', 103, 1, sysdate(), null, null, '因子版本退役权限'),
(910155, '因子版本恢复', 910103, 8, '', '', '', 1, 0, 'F', '0', '0', 'vendor:factorVersion:restore', '#', 103, 1, sysdate(), null, null, '因子版本恢复权限'),
...
(menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark)
values
(1, '系统管理', 0, 3, 'system', null, '', 1, 0, 'M', '0', '0', '', 'system', 103, 1, sysdate(), null, null, '系统管理目录'),
(100, '用户管理', 1, 1, 'user', 'system/user/index', '', 1, 0, 'C', '0', '0', 'system:user:list', 'user', 103, 1, sysdate(), null, null, '用户管理菜单'),
(101, '角色管理', 1, 2, 'role', 'system/role/index', '', 1, 0, 'C', '0', '0', 'system:role:list', 'peoples', 103, 1, sysdate(), null, null, '角色管理菜单'),
(103, '部门管理', 1, 4, 'dept', 'system/dept/index', '', 1, 0, 'C', '0', '0', 'system:dept:list', 'tree', 103, 1, sysdate(), null, null, '部门管理菜单'),
(104, '岗位管理', 1, 5, 'post', 'system/post/index', '', 1, 0, 'C', '0', '0', 'system:post:list', 'post', 103, 1, sysdate(), null, null, '岗位管理菜单'),
(122, '套餐管理', 1, 8, 'tenantPackage', 'system/tenantPackage/index', '', 1, 0, 'C', '0', '0', 'system:tenantPackage:list', 'form', 103, 1, sysdate(), null, null, '授权套餐管理菜单'),
(107, '通知公告', 1, 9, 'notice', 'system/notice/index', '', 1, 0, 'C', '0', '0', 'system:notice:list', 'message', 103, 1, sysdate(), null, null, '通知公告菜单'),
(108, '日志管理', 0, 4, 'monitor', 'Layout', '', 1, 0, 'M', '0', '0', '', 'log', 103, 1, sysdate(), null, null, '日志管理目录'),
(500, '操作日志', 108, 1, 'operlog', 'monitor/operlog/index', '', 1, 0, 'C', '0', '0', 'monitor:operlog:list', 'form', 103, 1, sysdate(), null, null, '操作日志菜单'),
(501, '登录日志', 108, 2, 'logininfor', 'monitor/logininfor/index', '', 1, 0, 'C', '0', '0', 'monitor:logininfor:list', 'logininfor', 103, 1, sysdate(), null, null, '登录日志菜单'),
(130, '角色新增', 101, 1, '', '', '', 1, 0, 'F', '0', '0', 'system:role:add', '#', 103, 1, sysdate(), null, null, '角色新增权限'),
(131, '用户编辑', 100, 1, '', '', '', 1, 0, 'F', '0', '0', 'system:user:edit', '#', 103, 1, sysdate(), null, null, '用户编辑权限'),
...
(1040, '操作日志查询', 500, 1, '', '', '', 1, 0, 'F', '0', '0', 'monitor:operlog:query', '#', 103, 1, sysdate(), null, null, '操作日志查询权限'),
(1041, '操作日志删除', 500, 2, '', '', '', 1, 0, 'F', '0', '0', 'monitor:operlog:remove', '#', 103, 1, sysdate(), null, null, '操作日志删除权限'),
(1042, '操作日志导出', 500, 3, '', '', '', 1, 0, 'F', '0', '0', 'monitor:operlog:export', '#', 103, 1, sysdate(), null, null, '操作日志导出权限'),
(1043, '登录日志查询', 501, 1, '', '', '', 1, 0, 'F', '0', '0', 'monitor:logininfor:query', '#', 103, 1, sysdate(), null, null, '登录日志查询权限'),
(1044, '登录日志删除', 501, 2, '', '', '', 1, 0, 'F', '0', '0', 'monitor:logininfor:remove', '#', 103, 1, sysdate(), null, null, '登录日志删除权限'),
(1045, '登录日志导出', 501, 3, '', '', '', 1, 0, 'F', '0', '0', 'monitor:logininfor:export', '#', 103, 1, sysdate(), null, null, '登录日志导出权限'),
