...
create table sys_tenant_package (
    ...
    billing_cycle           varchar(20)    default 'YEAR' comment '计费周期',
    online_purchase_enabled tinyint(1)     default 0   comment '是否允许在线购买',
    license_auto_issue_enabled tinyint(1)  default 0   comment '是否支付后自动签发License',
    license_key_id          varchar(64)                comment 'License签名keyId',
    license_validity_days   int                         comment 'License有效天数',
    license_feature_codes   varchar(1000)              comment 'License功能码，逗号分隔',
    license_template_entitlements text                 comment 'License报表模板授权JSON',
