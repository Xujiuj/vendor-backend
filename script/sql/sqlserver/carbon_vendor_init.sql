...
BEGIN TRY
    ...
    VALUES
        ...
        (910162, N'授权管理详情', 910102, 1, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'vendor:licenseIssue:query', N'#', N'授权管理详情权限'),
        (910163, N'授权管理签发', 910102, 2, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'vendor:licenseIssue:issue', N'#', N'授权管理签发权限'),
        (910164, N'授权管理撤销', 910102, 3, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'vendor:licenseIssue:revoke', N'#', N'授权管理撤销权限'),
        (910161, N'授权管理删除', 910102, 4, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'vendor:licenseIssue:remove', N'#', N'授权管理删除权限'),
    ...
    VALUES
        (1, N'2022110000', 2022, N'110000', N'北京市', N'华北', 0.558, 0.6776, 0.5366, 0.5856, 0.8325, 1, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (2, N'2022120000', 2022, N'120000', N'天津市', N'华北', 0.7041, 0.6776, 0.5366, 0.5856, 0.8325, 2, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (3, N'2022130000', 2022, N'130000', N'河北省', N'华北', 0.7252, 0.6776, 0.5366, 0.5856, 0.8325, 3, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (4, N'2022140000', 2022, N'140000', N'山西省', N'华北', 0.7096, 0.6776, 0.5366, 0.5856, 0.8325, 4, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (5, N'2022150001', 2022, N'150001', N'蒙西', N'华北', 0.6849, 0.6776, 0.5366, 0.5856, 0.8325, 5, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (6, N'2022150002', 2022, N'150002', N'蒙东', N'东北', 0.6849, 0.5564, 0.5366, 0.5856, 0.8325, 6, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (7, N'2022210000', 2022, N'210000', N'辽宁省', N'东北', 0.5626, 0.5564, 0.5366, 0.5856, 0.8325, 7, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (8, N'2022220000', 2022, N'220000', N'吉林省', N'东北', 0.4932, 0.5564, 0.5366, 0.5856, 0.8325, 8, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (9, N'2022230000', 2022, N'230000', N'黑龙江省', N'东北', 0.5368, 0.5564, 0.5366, 0.5856, 0.8325, 9, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (10, N'2022310000', 2022, N'310000', N'上海市', N'华东', 0.5849, 0.5617, 0.5366, 0.5856, 0.8325, 10, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (11, N'2022320000', 2022, N'320000', N'江苏省', N'华东', 0.5978, 0.5617, 0.5366, 0.5856, 0.8325, 11, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (12, N'2022330000', 2022, N'330000', N'浙江省', N'华东', 0.5153, 0.5617, 0.5366, 0.5856, 0.8325, 12, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (13, N'2022340000', 2022, N'340000', N'安徽省', N'华东', 0.6782, 0.5617, 0.5366, 0.5856, 0.8325, 13, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (14, N'2022350000', 2022, N'350000', N'福建省', N'华东', 0.4092, 0.5617, 0.5366, 0.5856, 0.8325, 14, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (15, N'2022360000', 2022, N'360000', N'江西省', N'华中', 0.5752, 0.5395, 0.5366, 0.5856, 0.8325, 15, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (16, N'2022370000', 2022, N'370000', N'山东省', N'华北', 0.641, 0.6776, 0.5366, 0.5856, 0.8325, 16, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (17, N'2022410000', 2022, N'410000', N'河南省', N'华中', 0.6058, 0.5395, 0.5366, 0.5856, 0.8325, 17, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (18, N'2022420000', 2022, N'420000', N'湖北省', N'华中', 0.4364, 0.5395, 0.5366, 0.5856, 0.8325, 18, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (19, N'2022430000', 2022, N'430000', N'湖南省', N'华中', 0.49, 0.5395, 0.5366, 0.5856, 0.8325, 19, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (20, N'2022440000', 2022, N'440000', N'广东省', N'南方', 0.4403, 0.3869, 0.5366, 0.5856, 0.8325, 20, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (21, N'2022450000', 2022, N'450000', N'广西壮族自治区', N'南方', 0.4044, 0.3869, 0.5366, 0.5856, 0.8325, 21, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (22, N'2022460000', 2022, N'460000', N'海南省', N'南方', 0.4184, 0.3869, 0.5366, 0.5856, 0.8325, 22, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (23, N'2022500000', 2022, N'500000', N'重庆市', N'西南', 0.5227, 0.2268, 0.5366, 0.5856, 0.8325, 23, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (24, N'2022510000', 2022, N'510000', N'四川省', N'西南', 0.1404, 0.2268, 0.5366, 0.5856, 0.8325, 24, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (25, N'2022520000', 2022, N'520000', N'贵州省', N'南方', 0.4989, 0.3869, 0.5366, 0.5856, 0.8325, 25, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (26, N'2022530000', 2022, N'530000', N'云南省', N'南方', 0.1073, 0.3869, 0.5366, 0.5856, 0.8325, 26, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (27, N'2022610000', 2022, N'610000', N'陕西省', N'西北', 0.6558, 0.5857, 0.5366, 0.5856, 0.8325, 27, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (28, N'2022620000', 2022, N'620000', N'甘肃省', N'西北', 0.4772, 0.5857, 0.5366, 0.5856, 0.8325, 28, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (29, N'2022630000', 2022, N'630000', N'青海省', N'西北', 0.1567, 0.5857, 0.5366, 0.5856, 0.8325, 29, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (30, N'2022640000', 2022, N'640000', N'宁夏回族自治区', N'西北', 0.6423, 0.5857, 0.5366, 0.5856, 0.8325, 30, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (31, N'2022650000', 2022, N'650000', N'新疆维吾尔自治区', N'西北', 0.6231, 0.5857, 0.5366, 0.5856, 0.8325, 31, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (32, N'2023110000', 2023, N'110000', N'北京市', N'华北', 0.5554, 0.6361, 0.5306, 0.6096, 0.8273, 32, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (33, N'2023120000', 2023, N'120000', N'天津市', N'华北', 0.6796, 0.6361, 0.5306, 0.6096, 0.8273, 33, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (34, N'2023130000', 2023, N'130000', N'河北省', N'华北', 0.6516, 0.6361, 0.5306, 0.6096, 0.8273, 34, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (35, N'2023140000', 2023, N'140000', N'山西省', N'华北', 0.6634, 0.6361, 0.5306, 0.6096, 0.8273, 35, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (36, N'2023150001', 2023, N'150001', N'蒙西', N'华北', 0.6479, 0.6361, 0.5306, 0.6096, 0.8273, 36, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (37, N'2023150002', 2023, N'150002', N'蒙东', N'东北', 0.6479, 0.5122, 0.5306, 0.6096, 0.8273, 37, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (38, N'2023210000', 2023, N'210000', N'辽宁省', N'东北', 0.4878, 0.5122, 0.5306, 0.6096, 0.8273, 38, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (39, N'2023220000', 2023, N'220000', N'吉林省', N'东北', 0.4671, 0.5122, 0.5306, 0.6096, 0.8273, 39, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (40, N'2023230000', 2023, N'230000', N'黑龙江省', N'东北', 0.5229, 0.5122, 0.5306, 0.6096, 0.8273, 40, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (41, N'2023310000', 2023, N'310000', N'上海市', N'华东', 0.5737, 0.55, 0.5306, 0.6096, 0.8273, 41, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (42, N'2023320000', 2023, N'320000', N'江苏省', N'华东', 0.5827, 0.55, 0.5306, 0.6096, 0.8273, 42, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (43, N'2023330000', 2023, N'330000', N'浙江省', N'华东', 0.4974, 0.55, 0.5306, 0.6096, 0.8273, 43, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (44, N'2023340000', 2023, N'340000', N'安徽省', N'华东', 0.6553, 0.55, 0.5306, 0.6096, 0.8273, 44, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (45, N'2023350000', 2023, N'350000', N'福建省', N'华东', 0.4211, 0.55, 0.5306, 0.6096, 0.8273, 45, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (46, N'2023360000', 2023, N'360000', N'江西省', N'华中', 0.5836, 0.5271, 0.5306, 0.6096, 0.8273, 46, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (47, N'2023370000', 2023, N'370000', N'山东省', N'华北', 0.6191, 0.6361, 0.5306, 0.6096, 0.8273, 47, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (48, N'2023410000', 2023, N'410000', N'河南省', N'华中', 0.5897, 0.5271, 0.5306, 0.6096, 0.8273, 48, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (49, N'2023420000', 2023, N'420000', N'湖北省', N'华中', 0.4044, 0.5271, 0.5306, 0.6096, 0.8273, 49, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (50, N'2023430000', 2023, N'430000', N'湖南省', N'华中', 0.4976, 0.5271, 0.5306, 0.6096, 0.8273, 50, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (51, N'2023440000', 2023, N'440000', N'广东省', N'南方', 0.4419, 0.4042, 0.5306, 0.6096, 0.8273, 51, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (52, N'2023450000', 2023, N'450000', N'广西壮族自治区', N'南方', 0.4476, 0.4042, 0.5306, 0.6096, 0.8273, 52, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (53, N'2023460000', 2023, N'460000', N'海南省', N'南方', 0.3648, 0.4042, 0.5306, 0.6096, 0.8273, 53, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (54, N'2023500000', 2023, N'500000', N'重庆市', N'西南', 0.5581, 0.2472, 0.5306, 0.6096, 0.8273, 54, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (55, N'2023510000', 2023, N'510000', N'四川省', N'西南', 0.1564, 0.2472, 0.5306, 0.6096, 0.8273, 55, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (56, N'2023520000', 2023, N'520000', N'贵州省', N'南方', 0.5683, 0.4042, 0.5306, 0.6096, 0.8273, 56, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (57, N'2023530000', 2023, N'530000', N'云南省', N'南方', 0.1333, 0.4042, 0.5306, 0.6096, 0.8273, 57, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (58, N'2023610000', 2023, N'610000', N'陕西省', N'西北', 0.6335, 0.5543, 0.5306, 0.6096, 0.8273, 58, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (59, N'2023620000', 2023, N'620000', N'甘肃省', N'西北', 0.4471, 0.5543, 0.5306, 0.6096, 0.8273, 59, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (60, N'2023630000', 2023, N'630000', N'青海省', N'西北', 0.1796, 0.5543, 0.5306, 0.6096, 0.8273, 60, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (61, N'2023640000', 2023, N'640000', N'宁夏回族自治区', N'西北', 0.6187, 0.5543, 0.5306, 0.6096, 0.8273, 61, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (62, N'2023650000', 2023, N'650000', N'新疆维吾尔自治区', N'西北', 0.6021, 0.5543, 0.5306, 0.6096, 0.8273, 62, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)');
    ...
    VALUES
        ...
        (68, 1, N'202ef', N'2022110000', N'北京市', N'ef-electricity-factor', 0.558, N'kgCO2/kWh', N'2022110000', N'电力', N'Electricity', N'电力', N'kWh', 0.558, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.558, N'2022110000', N'2022', N'110000', N'北京市', N'华北', 0.558, 0.6776, 0.5366, 0.5856, 0.8325, 68, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.558, 0.558, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (69, 1, N'202ef', N'2022120000', N'天津市', N'ef-electricity-factor', 0.7041, N'kgCO2/kWh', N'2022120000', N'电力', N'Electricity', N'电力', N'kWh', 0.7041, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.7041, N'2022120000', N'2022', N'120000', N'天津市', N'华北', 0.7041, 0.6776, 0.5366, 0.5856, 0.8325, 69, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.7041, 0.7041, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (70, 1, N'202ef', N'2022130000', N'河北省', N'ef-electricity-factor', 0.7252, N'kgCO2/kWh', N'2022130000', N'电力', N'Electricity', N'电力', N'kWh', 0.7252, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.7252, N'2022130000', N'2022', N'130000', N'河北省', N'华北', 0.7252, 0.6776, 0.5366, 0.5856, 0.8325, 70, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.7252, 0.7252, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (71, 1, N'202ef', N'2022140000', N'山西省', N'ef-electricity-factor', 0.7096, N'kgCO2/kWh', N'2022140000', N'电力', N'Electricity', N'电力', N'kWh', 0.7096, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.7096, N'2022140000', N'2022', N'140000', N'山西省', N'华北', 0.7096, 0.6776, 0.5366, 0.5856, 0.8325, 71, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.7096, 0.7096, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (72, 1, N'202ef', N'2022150001', N'蒙西', N'ef-electricity-factor', 0.6849, N'kgCO2/kWh', N'2022150001', N'电力', N'Electricity', N'电力', N'kWh', 0.6849, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.6849, N'2022150001', N'2022', N'150001', N'蒙西', N'华北', 0.6849, 0.6776, 0.5366, 0.5856, 0.8325, 72, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.6849, 0.6849, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (73, 1, N'202ef', N'2022150002', N'蒙东', N'ef-electricity-factor', 0.6849, N'kgCO2/kWh', N'2022150002', N'电力', N'Electricity', N'电力', N'kWh', 0.6849, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.6849, N'2022150002', N'2022', N'150002', N'蒙东', N'东北', 0.6849, 0.5564, 0.5366, 0.5856, 0.8325, 73, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.6849, 0.6849, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (74, 1, N'202ef', N'2022210000', N'辽宁省', N'ef-electricity-factor', 0.5626, N'kgCO2/kWh', N'2022210000', N'电力', N'Electricity', N'电力', N'kWh', 0.5626, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.5626, N'2022210000', N'2022', N'210000', N'辽宁省', N'东北', 0.5626, 0.5564, 0.5366, 0.5856, 0.8325, 74, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.5626, 0.5626, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (75, 1, N'202ef', N'2022220000', N'吉林省', N'ef-electricity-factor', 0.4932, N'kgCO2/kWh', N'2022220000', N'电力', N'Electricity', N'电力', N'kWh', 0.4932, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.4932, N'2022220000', N'2022', N'220000', N'吉林省', N'东北', 0.4932, 0.5564, 0.5366, 0.5856, 0.8325, 75, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.4932, 0.4932, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (76, 1, N'202ef', N'2022230000', N'黑龙江省', N'ef-electricity-factor', 0.5368, N'kgCO2/kWh', N'2022230000', N'电力', N'Electricity', N'电力', N'kWh', 0.5368, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.5368, N'2022230000', N'2022', N'230000', N'黑龙江省', N'东北', 0.5368, 0.5564, 0.5366, 0.5856, 0.8325, 76, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.5368, 0.5368, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (77, 1, N'202ef', N'2022310000', N'上海市', N'ef-electricity-factor', 0.5849, N'kgCO2/kWh', N'2022310000', N'电力', N'Electricity', N'电力', N'kWh', 0.5849, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.5849, N'2022310000', N'2022', N'310000', N'上海市', N'华东', 0.5849, 0.5617, 0.5366, 0.5856, 0.8325, 77, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.5849, 0.5849, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (78, 1, N'202ef', N'2022320000', N'江苏省', N'ef-electricity-factor', 0.5978, N'kgCO2/kWh', N'2022320000', N'电力', N'Electricity', N'电力', N'kWh', 0.5978, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.5978, N'2022320000', N'2022', N'320000', N'江苏省', N'华东', 0.5978, 0.5617, 0.5366, 0.5856, 0.8325, 78, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.5978, 0.5978, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (79, 1, N'202ef', N'2022330000', N'浙江省', N'ef-electricity-factor', 0.5153, N'kgCO2/kWh', N'2022330000', N'电力', N'Electricity', N'电力', N'kWh', 0.5153, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.5153, N'2022330000', N'2022', N'330000', N'浙江省', N'华东', 0.5153, 0.5617, 0.5366, 0.5856, 0.8325, 79, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.5153, 0.5153, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (80, 1, N'202ef', N'2022340000', N'安徽省', N'ef-electricity-factor', 0.6782, N'kgCO2/kWh', N'2022340000', N'电力', N'Electricity', N'电力', N'kWh', 0.6782, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.6782, N'2022340000', N'2022', N'340000', N'安徽省', N'华东', 0.6782, 0.5617, 0.5366, 0.5856, 0.8325, 80, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.6782, 0.6782, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (81, 1, N'202ef', N'2022350000', N'福建省', N'ef-electricity-factor', 0.4092, N'kgCO2/kWh', N'2022350000', N'电力', N'Electricity', N'电力', N'kWh', 0.4092, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.4092, N'2022350000', N'2022', N'350000', N'福建省', N'华东', 0.4092, 0.5617, 0.5366, 0.5856, 0.8325, 81, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.4092, 0.4092, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (82, 1, N'202ef', N'2022360000', N'江西省', N'ef-electricity-factor', 0.5752, N'kgCO2/kWh', N'2022360000', N'电力', N'Electricity', N'电力', N'kWh', 0.5752, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.5752, N'2022360000', N'2022', N'360000', N'江西省', N'华中', 0.5752, 0.5395, 0.5366, 0.5856, 0.8325, 82, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.5752, 0.5752, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (83, 1, N'202ef', N'2022370000', N'山东省', N'ef-electricity-factor', 0.641, N'kgCO2/kWh', N'2022370000', N'电力', N'Electricity', N'电力', N'kWh', 0.641, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.641, N'2022370000', N'2022', N'370000', N'山东省', N'华北', 0.641, 0.6776, 0.5366, 0.5856, 0.8325, 83, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.641, 0.641, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (84, 1, N'202ef', N'2022410000', N'河南省', N'ef-electricity-factor', 0.6058, N'kgCO2/kWh', N'2022410000', N'电力', N'Electricity', N'电力', N'kWh', 0.6058, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.6058, N'2022410000', N'2022', N'410000', N'河南省', N'华中', 0.6058, 0.5395, 0.5366, 0.5856, 0.8325, 84, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.6058, 0.6058, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (85, 1, N'202ef', N'2022420000', N'湖北省', N'ef-electricity-factor', 0.4364, N'kgCO2/kWh', N'2022420000', N'电力', N'Electricity', N'电力', N'kWh', 0.4364, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.4364, N'2022420000', N'2022', N'420000', N'湖北省', N'华中', 0.4364, 0.5395, 0.5366, 0.5856, 0.8325, 85, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.4364, 0.4364, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (86, 1, N'202ef', N'2022430000', N'湖南省', N'ef-electricity-factor', 0.49, N'kgCO2/kWh', N'2022430000', N'电力', N'Electricity', N'电力', N'kWh', 0.49, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.49, N'2022430000', N'2022', N'430000', N'湖南省', N'华中', 0.49, 0.5395, 0.5366, 0.5856, 0.8325, 86, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.49, 0.49, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (87, 1, N'202ef', N'2022440000', N'广东省', N'ef-electricity-factor', 0.4403, N'kgCO2/kWh', N'2022440000', N'电力', N'Electricity', N'电力', N'kWh', 0.4403, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.4403, N'2022440000', N'2022', N'440000', N'广东省', N'南方', 0.4403, 0.3869, 0.5366, 0.5856, 0.8325, 87, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.4403, 0.4403, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (88, 1, N'202ef', N'2022450000', N'广西壮族自治区', N'ef-electricity-factor', 0.4044, N'kgCO2/kWh', N'2022450000', N'电力', N'Electricity', N'电力', N'kWh', 0.4044, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.4044, N'2022450000', N'2022', N'450000', N'广西壮族自治区', N'南方', 0.4044, 0.3869, 0.5366, 0.5856, 0.8325, 88, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.4044, 0.4044, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (89, 1, N'202ef', N'2022460000', N'海南省', N'ef-electricity-factor', 0.4184, N'kgCO2/kWh', N'2022460000', N'电力', N'Electricity', N'电力', N'kWh', 0.4184, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.4184, N'2022460000', N'2022', N'460000', N'海南省', N'南方', 0.4184, 0.3869, 0.5366, 0.5856, 0.8325, 89, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.4184, 0.4184, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (90, 1, N'202ef', N'2022500000', N'重庆市', N'ef-electricity-factor', 0.5227, N'kgCO2/kWh', N'2022500000', N'电力', N'Electricity', N'电力', N'kWh', 0.5227, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.5227, N'2022500000', N'2022', N'500000', N'重庆市', N'西南', 0.5227, 0.2268, 0.5366, 0.5856, 0.8325, 90, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.5227, 0.5227, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (91, 1, N'202ef', N'2022510000', N'四川省', N'ef-electricity-factor', 0.1404, N'kgCO2/kWh', N'2022510000', N'电力', N'Electricity', N'电力', N'kWh', 0.1404, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.1404, N'2022510000', N'2022', N'510000', N'四川省', N'西南', 0.1404, 0.2268, 0.5366, 0.5856, 0.8325, 91, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.1404, 0.1404, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (92, 1, N'202ef', N'2022520000', N'贵州省', N'ef-electricity-factor', 0.4989, N'kgCO2/kWh', N'2022520000', N'电力', N'Electricity', N'电力', N'kWh', 0.4989, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.4989, N'2022520000', N'2022', N'520000', N'贵州省', N'南方', 0.4989, 0.3869, 0.5366, 0.5856, 0.8325, 92, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.4989, 0.4989, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (93, 1, N'202ef', N'2022530000', N'云南省', N'ef-electricity-factor', 0.1073, N'kgCO2/kWh', N'2022530000', N'电力', N'Electricity', N'电力', N'kWh', 0.1073, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.1073, N'2022530000', N'2022', N'530000', N'云南省', N'南方', 0.1073, 0.3869, 0.5366, 0.5856, 0.8325, 93, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.1073, 0.1073, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (94, 1, N'202ef', N'2022610000', N'陕西省', N'ef-electricity-factor', 0.6558, N'kgCO2/kWh', N'2022610000', N'电力', N'Electricity', N'电力', N'kWh', 0.6558, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.6558, N'2022610000', N'2022', N'610000', N'陕西省', N'西北', 0.6558, 0.5857, 0.5366, 0.5856, 0.8325, 94, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.6558, 0.6558, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (95, 1, N'202ef', N'2022620000', N'甘肃省', N'ef-electricity-factor', 0.4772, N'kgCO2/kWh', N'2022620000', N'电力', N'Electricity', N'电力', N'kWh', 0.4772, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.4772, N'2022620000', N'2022', N'620000', N'甘肃省', N'西北', 0.4772, 0.5857, 0.5366, 0.5856, 0.8325, 95, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.4772, 0.4772, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (96, 1, N'202ef', N'2022630000', N'青海省', N'ef-electricity-factor', 0.1567, N'kgCO2/kWh', N'2022630000', N'电力', N'Electricity', N'电力', N'kWh', 0.1567, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.1567, N'2022630000', N'2022', N'630000', N'青海省', N'西北', 0.1567, 0.5857, 0.5366, 0.5856, 0.8325, 96, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.1567, 0.1567, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (97, 1, N'202ef', N'2022640000', N'宁夏回族自治区', N'ef-electricity-factor', 0.6423, N'kgCO2/kWh', N'2022640000', N'电力', N'Electricity', N'电力', N'kWh', 0.6423, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.6423, N'2022640000', N'2022', N'640000', N'宁夏回族自治区', N'西北', 0.6423, 0.5857, 0.5366, 0.5856, 0.8325, 97, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.6423, 0.6423, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (98, 1, N'202ef', N'2022650000', N'新疆维吾尔自治区', N'ef-electricity-factor', 0.6231, N'kgCO2/kWh', N'2022650000', N'电力', N'Electricity', N'电力', N'kWh', 0.6231, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.6231, N'2022650000', N'2022', N'650000', N'新疆维吾尔自治区', N'西北', 0.6231, 0.5857, 0.5366, 0.5856, 0.8325, 98, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.6231, 0.6231, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (99, 1, N'202ef', N'2023110000', N'北京市', N'ef-electricity-factor', 0.5554, N'kgCO2/kWh', N'2023110000', N'电力', N'Electricity', N'电力', N'kWh', 0.5554, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.5554, N'2023110000', N'2023', N'110000', N'北京市', N'华北', 0.5554, 0.6361, 0.5306, 0.6096, 0.8273, 99, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.5554, 0.5554, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (100, 1, N'202ef', N'2023120000', N'天津市', N'ef-electricity-factor', 0.6796, N'kgCO2/kWh', N'2023120000', N'电力', N'Electricity', N'电力', N'kWh', 0.6796, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.6796, N'2023120000', N'2023', N'120000', N'天津市', N'华北', 0.6796, 0.6361, 0.5306, 0.6096, 0.8273, 100, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.6796, 0.6796, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (101, 1, N'202ef', N'2023130000', N'河北省', N'ef-electricity-factor', 0.6516, N'kgCO2/kWh', N'2023130000', N'电力', N'Electricity', N'电力', N'kWh', 0.6516, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.6516, N'2023130000', N'2023', N'130000', N'河北省', N'华北', 0.6516, 0.6361, 0.5306, 0.6096, 0.8273, 101, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.6516, 0.6516, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (102, 1, N'202ef', N'2023140000', N'山西省', N'ef-electricity-factor', 0.6634, N'kgCO2/kWh', N'2023140000', N'电力', N'Electricity', N'电力', N'kWh', 0.6634, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.6634, N'2023140000', N'2023', N'140000', N'山西省', N'华北', 0.6634, 0.6361, 0.5306, 0.6096, 0.8273, 102, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.6634, 0.6634, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (103, 1, N'202ef', N'2023150001', N'蒙西', N'ef-electricity-factor', 0.6479, N'kgCO2/kWh', N'2023150001', N'电力', N'Electricity', N'电力', N'kWh', 0.6479, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.6479, N'2023150001', N'2023', N'150001', N'蒙西', N'华北', 0.6479, 0.6361, 0.5306, 0.6096, 0.8273, 103, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.6479, 0.6479, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (104, 1, N'202ef', N'2023150002', N'蒙东', N'ef-electricity-factor', 0.6479, N'kgCO2/kWh', N'2023150002', N'电力', N'Electricity', N'电力', N'kWh', 0.6479, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.6479, N'2023150002', N'2023', N'150002', N'蒙东', N'东北', 0.6479, 0.5122, 0.5306, 0.6096, 0.8273, 104, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.6479, 0.6479, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (105, 1, N'202ef', N'2023210000', N'辽宁省', N'ef-electricity-factor', 0.4878, N'kgCO2/kWh', N'2023210000', N'电力', N'Electricity', N'电力', N'kWh', 0.4878, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.4878, N'2023210000', N'2023', N'210000', N'辽宁省', N'东北', 0.4878, 0.5122, 0.5306, 0.6096, 0.8273, 105, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.4878, 0.4878, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (106, 1, N'202ef', N'2023220000', N'吉林省', N'ef-electricity-factor', 0.4671, N'kgCO2/kWh', N'2023220000', N'电力', N'Electricity', N'电力', N'kWh', 0.4671, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.4671, N'2023220000', N'2023', N'220000', N'吉林省', N'东北', 0.4671, 0.5122, 0.5306, 0.6096, 0.8273, 106, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.4671, 0.4671, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (107, 1, N'202ef', N'2023230000', N'黑龙江省', N'ef-electricity-factor', 0.5229, N'kgCO2/kWh', N'2023230000', N'电力', N'Electricity', N'电力', N'kWh', 0.5229, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.5229, N'2023230000', N'2023', N'230000', N'黑龙江省', N'东北', 0.5229, 0.5122, 0.5306, 0.6096, 0.8273, 107, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.5229, 0.5229, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (108, 1, N'202ef', N'2023310000', N'上海市', N'ef-electricity-factor', 0.5737, N'kgCO2/kWh', N'2023310000', N'电力', N'Electricity', N'电力', N'kWh', 0.5737, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.5737, N'2023310000', N'2023', N'310000', N'上海市', N'华东', 0.5737, 0.55, 0.5306, 0.6096, 0.8273, 108, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.5737, 0.5737, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (109, 1, N'202ef', N'2023320000', N'江苏省', N'ef-electricity-factor', 0.5827, N'kgCO2/kWh', N'2023320000', N'电力', N'Electricity', N'电力', N'kWh', 0.5827, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.5827, N'2023320000', N'2023', N'320000', N'江苏省', N'华东', 0.5827, 0.55, 0.5306, 0.6096, 0.8273, 109, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.5827, 0.5827, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (110, 1, N'202ef', N'2023330000', N'浙江省', N'ef-electricity-factor', 0.4974, N'kgCO2/kWh', N'2023330000', N'电力', N'Electricity', N'电力', N'kWh', 0.4974, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.4974, N'2023330000', N'2023', N'330000', N'浙江省', N'华东', 0.4974, 0.55, 0.5306, 0.6096, 0.8273, 110, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.4974, 0.4974, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (111, 1, N'202ef', N'2023340000', N'安徽省', N'ef-electricity-factor', 0.6553, N'kgCO2/kWh', N'2023340000', N'电力', N'Electricity', N'电力', N'kWh', 0.6553, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.6553, N'2023340000', N'2023', N'340000', N'安徽省', N'华东', 0.6553, 0.55, 0.5306, 0.6096, 0.8273, 111, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.6553, 0.6553, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (112, 1, N'202ef', N'2023350000', N'福建省', N'ef-electricity-factor', 0.4211, N'kgCO2/kWh', N'2023350000', N'电力', N'Electricity', N'电力', N'kWh', 0.4211, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.4211, N'2023350000', N'2023', N'350000', N'福建省', N'华东', 0.4211, 0.55, 0.5306, 0.6096, 0.8273, 112, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.4211, 0.4211, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (113, 1, N'202ef', N'2023360000', N'江西省', N'ef-electricity-factor', 0.5836, N'kgCO2/kWh', N'2023360000', N'电力', N'Electricity', N'电力', N'kWh', 0.5836, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.5836, N'2023360000', N'2023', N'360000', N'江西省', N'华中', 0.5836, 0.5271, 0.5306, 0.6096, 0.8273, 113, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.5836, 0.5836, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (114, 1, N'202ef', N'2023370000', N'山东省', N'ef-electricity-factor', 0.6191, N'kgCO2/kWh', N'2023370000', N'电力', N'Electricity', N'电力', N'kWh', 0.6191, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.6191, N'2023370000', N'2023', N'370000', N'山东省', N'华北', 0.6191, 0.6361, 0.5306, 0.6096, 0.8273, 114, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.6191, 0.6191, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (115, 1, N'202ef', N'2023410000', N'河南省', N'ef-electricity-factor', 0.5897, N'kgCO2/kWh', N'2023410000', N'电力', N'Electricity', N'电力', N'kWh', 0.5897, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.5897, N'2023410000', N'2023', N'410000', N'河南省', N'华中', 0.5897, 0.5271, 0.5306, 0.6096, 0.8273, 115, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.5897, 0.5897, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (116, 1, N'202ef', N'2023420000', N'湖北省', N'ef-electricity-factor', 0.4044, N'kgCO2/kWh', N'2023420000', N'电力', N'Electricity', N'电力', N'kWh', 0.4044, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.4044, N'2023420000', N'2023', N'420000', N'湖北省', N'华中', 0.4044, 0.5271, 0.5306, 0.6096, 0.8273, 116, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.4044, 0.4044, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (117, 1, N'202ef', N'2023430000', N'湖南省', N'ef-electricity-factor', 0.4976, N'kgCO2/kWh', N'2023430000', N'电力', N'Electricity', N'电力', N'kWh', 0.4976, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.4976, N'2023430000', N'2023', N'430000', N'湖南省', N'华中', 0.4976, 0.5271, 0.5306, 0.6096, 0.8273, 117, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.4976, 0.4976, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (118, 1, N'202ef', N'2023440000', N'广东省', N'ef-electricity-factor', 0.4419, N'kgCO2/kWh', N'2023440000', N'电力', N'Electricity', N'电力', N'kWh', 0.4419, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.4419, N'2023440000', N'2023', N'440000', N'广东省', N'南方', 0.4419, 0.4042, 0.5306, 0.6096, 0.8273, 118, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.4419, 0.4419, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (119, 1, N'202ef', N'2023450000', N'广西壮族自治区', N'ef-electricity-factor', 0.4476, N'kgCO2/kWh', N'2023450000', N'电力', N'Electricity', N'电力', N'kWh', 0.4476, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.4476, N'2023450000', N'2023', N'450000', N'广西壮族自治区', N'南方', 0.4476, 0.4042, 0.5306, 0.6096, 0.8273, 119, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.4476, 0.4476, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (120, 1, N'202ef', N'2023460000', N'海南省', N'ef-electricity-factor', 0.3648, N'kgCO2/kWh', N'2023460000', N'电力', N'Electricity', N'电力', N'kWh', 0.3648, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.3648, N'2023460000', N'2023', N'460000', N'海南省', N'南方', 0.3648, 0.4042, 0.5306, 0.6096, 0.8273, 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.3648, 0.3648, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (121, 1, N'202ef', N'2023500000', N'重庆市', N'ef-electricity-factor', 0.5581, N'kgCO2/kWh', N'2023500000', N'电力', N'Electricity', N'电力', N'kWh', 0.5581, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.5581, N'2023500000', N'2023', N'500000', N'重庆市', N'西南', 0.5581, 0.2472, 0.5306, 0.6096, 0.8273, 121, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.5581, 0.5581, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (122, 1, N'202ef', N'2023510000', N'四川省', N'ef-electricity-factor', 0.1564, N'kgCO2/kWh', N'2023510000', N'电力', N'Electricity', N'电力', N'kWh', 0.1564, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.1564, N'2023510000', N'2023', N'510000', N'四川省', N'西南', 0.1564, 0.2472, 0.5306, 0.6096, 0.8273, 122, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.1564, 0.1564, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (123, 1, N'202ef', N'2023520000', N'贵州省', N'ef-electricity-factor', 0.5683, N'kgCO2/kWh', N'2023520000', N'电力', N'Electricity', N'电力', N'kWh', 0.5683, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.5683, N'2023520000', N'2023', N'520000', N'贵州省', N'南方', 0.5683, 0.4042, 0.5306, 0.6096, 0.8273, 123, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.5683, 0.5683, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (124, 1, N'202ef', N'2023530000', N'云南省', N'ef-electricity-factor', 0.1333, N'kgCO2/kWh', N'2023530000', N'电力', N'Electricity', N'电力', N'kWh', 0.1333, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.1333, N'2023530000', N'2023', N'530000', N'云南省', N'南方', 0.1333, 0.4042, 0.5306, 0.6096, 0.8273, 124, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.1333, 0.1333, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (125, 1, N'202ef', N'2023610000', N'陕西省', N'ef-electricity-factor', 0.6335, N'kgCO2/kWh', N'2023610000', N'电力', N'Electricity', N'电力', N'kWh', 0.6335, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.6335, N'2023610000', N'2023', N'610000', N'陕西省', N'西北', 0.6335, 0.5543, 0.5306, 0.6096, 0.8273, 125, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.6335, 0.6335, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (126, 1, N'202ef', N'2023620000', N'甘肃省', N'ef-electricity-factor', 0.4471, N'kgCO2/kWh', N'2023620000', N'电力', N'Electricity', N'电力', N'kWh', 0.4471, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.4471, N'2023620000', N'2023', N'620000', N'甘肃省', N'西北', 0.4471, 0.5543, 0.5306, 0.6096, 0.8273, 126, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.4471, 0.4471, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (127, 1, N'202ef', N'2023630000', N'青海省', N'ef-electricity-factor', 0.1796, N'kgCO2/kWh', N'2023630000', N'电力', N'Electricity', N'电力', N'kWh', 0.1796, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.1796, N'2023630000', N'2023', N'630000', N'青海省', N'西北', 0.1796, 0.5543, 0.5306, 0.6096, 0.8273, 127, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.1796, 0.1796, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (128, 1, N'202ef', N'2023640000', N'宁夏回族自治区', N'ef-electricity-factor', 0.6187, N'kgCO2/kWh', N'2023640000', N'电力', N'Electricity', N'电力', N'kWh', 0.6187, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.6187, N'2023640000', N'2023', N'640000', N'宁夏回族自治区', N'西北', 0.6187, 0.5543, 0.5306, 0.6096, 0.8273, 128, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.6187, 0.6187, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)'),
        (129, 1, N'202ef', N'2023650000', N'新疆维吾尔自治区', N'ef-electricity-factor', 0.6021, N'kgCO2/kWh', N'2023650000', N'电力', N'Electricity', N'电力', N'kWh', 0.6021, 0, 0, NULL, NULL, NULL, NULL, N'电力因子', N'source(A)', NULL, NULL, NULL, NULL, NULL, NULL, 0.6021, N'2023650000', N'2023', N'650000', N'新疆维吾尔自治区', N'西北', 0.6021, 0.5543, 0.5306, 0.6096, 0.8273, 129, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.6021, 0.6021, N'202EF电力因子维度表', NULL, 1, @now, NULL, N'source(A)');
