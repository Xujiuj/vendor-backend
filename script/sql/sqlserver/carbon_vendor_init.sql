...
BEGIN TRY
    ...
    VALUES
        ...
        (2, NULL, 2, N'1.2 时间趋势', N'["CO2e排放总量趋势分析（按照年份）", "CO2e排放总量趋势分析（按照月份）", "CO2e排放总量趋势分析（同比）", "CO2e排放总量趋势分析（环比）"]', 2, N'0', @now, NULL, N'source(A)'),
        (3, NULL, 3, N'1.3 数据导出', N'["CO2e排放总量（按照GHG Protocol体系分类）", "CO2e排放总量（按照ISO 14064‑1体系分类）", "CO2e排放总量（按照GB/T 32150‑2025体系分类）", "范围二外购电力CO2e排放总量"]', 3, N'0', @now, NULL, N'source(A)'),
        ...
        (6, NULL, 6, N'3.2 排放源识别', N'["排放源识别清单"]', 6, N'0', @now, NULL, N'source(A)'),
        ...
        (9, NULL, 9, N'5.2 电力因子库', N'["电力排放因子表", "年份和电力因子对应表"]', 9, N'0', @now, NULL, N'source(A)'),
        ...
        (11, NULL, 11, N'6.2 细分排放', N'["CO2e排放总量（按照工厂分类）", "CO2e排放总量（按照行业分类）", "范围二外购电力CO2e排放总量"]', 11, N'0', @now, NULL, N'source(A)'),
        (12, NULL, 12, N'6.3 基准年对比', N'["年度排放量 vs 基准年（绝对量）", "相对基准年的增减量（Δ 排放）", "相对基准年的减排率（%）", "按照排放范围对比", "报告年份 vs 基准年", "同比 vs 基准年差值"]', 12, N'0', @now, NULL, N'source(A)'),
        (13, NULL, 13, N'6.4 GHGP视图', N'["CO2e排放总量（按照GHG Protocol体系分类）"]', 13, N'0', @now, NULL, N'source(A)'),
        (14, NULL, 14, N'6.5 ISO视图', N'["CO2e排放总量（按照ISO 14064‑1体系分类）"]', 14, N'0', @now, NULL, N'source(A)'),
        (15, NULL, 15, N'6.6 国标视图', N'["CO2e排放总量（按照GB/T 32150‑2025体系分类）"]', 15, N'0', @now, NULL, N'source(A)'),
        (16, NULL, 16, N'6.7 温室气体构成', N'["温室气体排放量", "温室气体排放趋势", "温室气体排放量（换算成CO2）"]', 16, N'0', @now, NULL, N'source(A)'),
        (7, N'7 行业对比分析', 17, N'7.1 工厂对比分析', N'["（预留页面）"]', 17, N'0', @now, NULL, N'source(A)'),
        (18, NULL, 18, N'7.2 行业对标分析', N'["（预留页面）"]', 18, N'0', @now, NULL, N'source(A)'),
        (8, N'8 碳排放强度管理', 19, N'8.1 强度总览', N'["碳排放强度汇总表", "碳排放强度执行情况（实际 vs 目标）", "工厂碳排放强度单位表", "碳排放强度趋势", "碳排放强度 vs 基准年（绝对量）"]', 19, N'0', @now, NULL, N'source(A)'),
        (20, NULL, 20, N'8.2 强度对比', N'["工厂碳排放强度单位表", "碳排放强度 vs 产量", "碳排放强度vs基准年 差值", "碳排放强度 vs CO2e排放量"]', 20, N'0', @now, NULL, N'source(A)'),
        (21, NULL, 21, N'8.3 行业强度对标', N'["（预留页面）"]', 21, N'0', @now, NULL, N'source(A)'),
        ...
        (24, NULL, 24, N'10.2 方法学说明', N'["10.2.1 排放核算基本方法", "10.2.2 多气体核算与 CO2e 折算", "10.2.3 排放因子与口径控制方法", "10.2.4 基准年与变化分析方法", "10.2.5 碳排放强度计算方法"]', 24, N'0', @now, NULL, N'source(A)');
    ...
    VALUES
        ...
        (2, NULL, NULL, N'2', N'1.2 时间趋势', N'["CO2e排放总量趋势分析（按照年份）", "CO2e排放总量趋势分析（按照月份）", "CO2e排放总量趋势分析（同比）", "CO2e排放总量趋势分析（环比）"]', 2, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (3, NULL, NULL, N'3', N'1.3 数据导出', N'["CO2e排放总量（按照GHG Protocol体系分类）", "CO2e排放总量（按照ISO 14064‑1体系分类）", "CO2e排放总量（按照GB/T 32150‑2025体系分类）", "范围二外购电力CO2e排放总量"]', 3, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        ...
        (6, NULL, NULL, N'6', N'3.2 排放源识别', N'["排放源识别清单"]', 6, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        ...
        (9, NULL, NULL, N'9', N'5.2 电力因子库', N'["电力排放因子表", "年份和电力因子对应表"]', 9, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        ...
        (11, NULL, NULL, N'11', N'6.2 细分排放', N'["CO2e排放总量（按照工厂分类）", "CO2e排放总量（按照行业分类）", "范围二外购电力CO2e排放总量"]', 11, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (12, NULL, NULL, N'12', N'6.3 基准年对比', N'["年度排放量 vs 基准年（绝对量）", "相对基准年的增减量（Δ 排放）", "相对基准年的减排率（%）", "按照排放范围对比", "报告年份 vs 基准年", "同比 vs 基准年差值"]', 12, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (13, NULL, NULL, N'13', N'6.4 GHGP视图', N'["CO2e排放总量（按照GHG Protocol体系分类）"]', 13, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (14, NULL, NULL, N'14', N'6.5 ISO视图', N'["CO2e排放总量（按照ISO 14064‑1体系分类）"]', 14, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (15, NULL, NULL, N'15', N'6.6 国标视图', N'["CO2e排放总量（按照GB/T 32150‑2025体系分类）"]', 15, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (16, NULL, NULL, N'16', N'6.7 温室气体构成', N'["温室气体排放量", "温室气体排放趋势", "温室气体排放量（换算成CO2）"]', 16, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (17, N'7', N'7 行业对比分析', N'17', N'7.1 工厂对比分析', N'["（预留页面）"]', 17, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (18, NULL, NULL, N'18', N'7.2 行业对标分析', N'["（预留页面）"]', 18, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        ...
        (20, NULL, NULL, N'20', N'8.2 强度对比', N'["工厂碳排放强度单位表", "碳排放强度 vs 产量", "碳排放强度vs基准年 差值", "碳排放强度 vs CO2e排放量"]', 20, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        (21, NULL, NULL, N'21', N'8.3 行业强度对标', N'["（预留页面）"]', 21, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)'),
        ...
        (24, NULL, NULL, N'24', N'10.2 方法学说明', N'["10.2.1 排放核算基本方法", "10.2.2 多气体核算与 CO2e 折算", "10.2.3 排放因子与口径控制方法", "10.2.4 基准年与变化分析方法", "10.2.5 碳排放强度计算方法"]', 24, N'0', @createDept, @createBy, @now, NULL, NULL, N'source(A)');
